...
function spawnBoss(bossType) {
  ...
  if (bossType === 'titan') {
    ...
    bosses.push({ id: 'thunder_boss', name: '⚡ 雷霆哨兵 (THUNDER SENTINEL)', x: canvas.width / 2 + (Math.random() * 200 - 100), y: -60, hp: 410 + hpBonus, maxHp: 410 + hpBonus, speed: 1.9, radius: 34, color: '#0ea5e9', stunned: 0, slowed: false, skillTimer: 210 });
